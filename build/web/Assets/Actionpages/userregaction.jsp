...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("userphoto"))//write the name of image here it is img_product
                        {
                        ...
                        if (field_name.equals("userproof"))//write the name of image here it is img_product
                        {
                            String ext = file_name.substring(file_name.lastIndexOf("."));//means the extension is stored to variable ext
                            //setting path to store image
                            File proj_path = new File(config.getServletContext().getRealPath("/"));
           ...
           //to upload proof of doctor
                ...
                String InsQry = "insert into tbl_user(user_name,user_contact,user_email,user_address,user_photo,user_proof,place_id,user_password,user_doj)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','" + proof + "','" + value[5] + "','" + value[6]+ "',curdate())";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Guest/Userreg.jsp';
