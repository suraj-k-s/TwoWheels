...
//checking if request cotains multipart data
            ...
            //f_item=(FileItem)itr.next();
                        ...
                        if (field_name.equals("photo"))//write the name of image here it is img_product
                        {
                            ...
                            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\Web\\Assets\\newvehicle\\";//path for storing image
              ...
              //String str1="insert into tbl_user ()";//inserting file
                String InsQry = "insert into tbl_newvehicle(vehicle_name,type_id,displacement_id,brand_id,vehicle_photo,vehicle_mileage,vehicle_price,vehicle_power,vehicle_torque,vehicle_maxspeed,vehicle_transmission,vehicle_fueltank,vehicle_weight,vehicle_height,vehicle_date)values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','" + value[4] + "','" + value[5] + "','" + value[6]+ "','" + value[7] + "','" + value[8] + "','" + value[9]+ "','" + value[10] + "','" + value[11] + "','" + value[12]+ "',curdate())";
   ...
   System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../../Admin/addveh.jsp';
