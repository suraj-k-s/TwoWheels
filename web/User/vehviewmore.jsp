        ...
        <h1 align="center">More details of used bike</h1>
                ...
                <%
                    if (request.getParameter("eid") != null) {
                        String seli="select * from tbl_payment where vehicle_id='"+request.getParameter("eid")+"' and user_id='" + session.getAttribute("userid") + "'";
                        ResultSet se=con.selectCommand(seli);
                        if(!se.next()){
            ...
            setTimeout(function() {
                window.location.href = 'vehrequests.jsp';
