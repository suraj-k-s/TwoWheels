    ...
    <div class="form">
      ...
      <div class="card space icon-relative">
        ...
        <div class="card-item icon-relative">
          ...
          <input type="text" name="totalamnt" placeholder="Amount">
...
<%
    if(request.getParameter("payid")!=null){
        session.setAttribute("payid", request.getParameter("payid"));
    }

if(request.getParameter("btnpay")!=null)
{
    String upd="update tbl_payment set payment_status='1',payment_date=curdate(),payment_amount='"+request.getParameter("totalamnt")+"' where payment_id='"+session.getAttribute("payid")+"'";
    con.executeCommand(upd);
    response.sendRedirect("vehrequests.jsp");
}
%>
</html>
