        ...
        <div id="tab" align="center">
            ...
            <table align="center">
                <tr>
                    ...
                    <td>
                        <p style="border: 10px solid black;margin: 2px;padding: 30px"> 
                            ...
                            <a href="ratereview.jsp?vehicle_id=<%=rs.getString("vehicle_id")%>"> view vehicle review</a><br>
                            <a href="Rating.jsp?aid=<%=rs.getString("vehicle_id")%>"> Add vehicle Rating</a><br>
