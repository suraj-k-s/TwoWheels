...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!--font-family-->
		<link href="../Assets/Template/Main/https://fonts.googleapis.com/css?family=Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

		<link href="../Assets/Template/Main/https://fonts.googleapis.com/css?family=Rufina:400,700" rel="stylesheet">
		...
		<section id="home" class="welcome-hero">
				        ...
				        <div class="container">
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
				                    ...
				                    <li class="scroll"><a href="Myprofile.jsp">Buy Bikes</a></li>
				                    <li class="scroll"><a href="#featured-cars">buy bikes</a></li>
			...
			<div class="container">
				<div class="welcome-hero-txt">
					<h2>Get you desired Bike in your dreams</h2>
					<p>
						MAde by anagha with some love 
					</p>
...
<!--							<div class="single-featured-cars">
        ...
        <!--modernizr.min.js-->
        <script src="../Assets/Template/Main/https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
		...
		<script src="../Assets/Template/Main/https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js"></script>
