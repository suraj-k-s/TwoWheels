    ...
    <body>
        ...
        <!-- Header -->
                            ...
                            <section class="case-study">
                                <div class="container">
                                    <h2>Add and View Bikes</h2>
                                    <p>Add and View Second Hand Bikes</p>
                                        ...
                                        <div class="case-study--left">
                                            <div class="case-study--left__textslider">
                                                <div>
                                                    ...
                                                    <h4>Add used Bikes</h4>
                                                    <p>Add used bikes to user to sell.</p>
                                                    <a href="ausedveh.jsp" class="button small">Add</a>
                                                </div>
                                                <div>
                                                    <div class="case-study--left__textslider__image"><i class="fa fa-lightbulb-o"
                                                                                                        aria-hidden="true"></i></div>
                                                    <h4>View Second Hand Bikes</h4>
                                                    <p>View Second Hand Bikes and book and update bike info.</p>
                                                    <a href="vusedveh.jsp" class="button small">View</a>
                                                </div>
