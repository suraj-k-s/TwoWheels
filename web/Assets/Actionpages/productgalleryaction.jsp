...
//checking if request cotains multipart data
                        ...
                        String ext = file_name.substring(file_name.lastIndexOf("."));//means the extension is stored to variable ext
                          //setting path to store image
                           ...
                           Random r = new Random();//to generate random number
                            ...
                            image = "file_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
           ...
           //to upload proof of doctor
                ...
                String InsQry = " insert into tbl_vg(vg_caption,vg_image,usedvehicle_id)values('" + value[0] + "','" + image + "','"+session.getAttribute("gid")+"')";
   ...
   //System.out.println(InsQry);
        ...
        <script type="text/javascript">
            ...
            setTimeout(function() {
                window.location.href = '../Seller/gallery.jsp'
